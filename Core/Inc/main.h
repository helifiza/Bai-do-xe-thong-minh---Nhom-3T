...
#define LED_GREEN2_GPIO_Port GPIOD
#define LED_GREEN3_Pin GPIO_PIN_2
#define LED_GREEN3_GPIO_Port GPIOD
#define LED_RED1_Pin GPIO_PIN_3
#define LED_RED1_GPIO_Port GPIOD
#define LED_RED2_Pin GPIO_PIN_4
#define LED_RED2_GPIO_Port GPIOD
#define LED_RED3_Pin GPIO_PIN_5
#define LED_RED3_GPIO_Port GPIOD
